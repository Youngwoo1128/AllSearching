 ...
 */
public abstract class Hilt_StorageFragment<T extends ViewDataBinding> extends BindingFragment<T> implements GeneratedComponentManagerHolder {
  ...
  Hilt_StorageFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((StorageFragment_GeneratedInjector) this.generatedComponent()).injectStorageFragment(UnsafeCasts.<StorageFragment>unsafeCast(this));
    }
  }
