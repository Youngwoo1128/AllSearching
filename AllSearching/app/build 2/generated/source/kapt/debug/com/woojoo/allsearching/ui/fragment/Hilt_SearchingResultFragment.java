 ...
 */
public abstract class Hilt_SearchingResultFragment<T extends ViewDataBinding> extends BindingFragment<T> implements GeneratedComponentManagerHolder {
  ...
  Hilt_SearchingResultFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SearchingResultFragment_GeneratedInjector) this.generatedComponent()).injectSearchingResultFragment(UnsafeCasts.<SearchingResultFragment>unsafeCast(this));
    }
  }
